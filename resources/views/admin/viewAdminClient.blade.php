...
@section('title','Client | fitnessHub')
            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="{{ route('admin.viewAdminClient') }}">client</a></li>
                                                            ...
                                                            @if(isset($clients))
                                                                @foreach($clients as $key => $client)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$clients->prenom_client}}</td>
                                                                        <td>{{$clients->adresse_client}}</td>
                                                                        <td>{{$coache->email_client}}</td>
                                                                ...
                                                                @endforeach
                                                            @else
                                                                <tr> aucuns clients enregistré</tr>
                                                            @endif
                    ...
                    <form method="POST" action="{{route('admin.viewAdminCoach')}}" class="register-form ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="name" name="adresse" required>
                            </div>
                            <div class="col-lg-6">
