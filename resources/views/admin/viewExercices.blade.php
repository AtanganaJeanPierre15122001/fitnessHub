            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="{{ route('admin.viewExercices') }}">Exercices</a></li>
                                                            ...
                                                            @if(isset($exercices))
                                                                @foreach($exercices as $key => $exercice)
                                                                    <tr>
                                                                        ...
                                                                        <td><form action="{{route('admin.viewExercices', $exercice->id)}}" method="DELETE" onsubmit="alert('Êtes-vous sûr de vouloir supprimer ce coach ?')">@csrf @method('DELETE') <button type="submit" class="btn btn-danger">delete</button></form></td>
                                                                    </tr>
                                                                @endforeach
                                                            @else
                                                                <tr> aucuns exercices enregistré</tr>
                                                            @endif
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="register-text bg-light">
                    ...
                    <form method="POST" action="{{route('admin.viewExercices')}}" class="register-form ">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="name">nom Exercice</label>
